...
x_validation_data_2, y_validation_data_2, class_count = create_training_data(sampling.ParameterSet(17, 1, 5, 0), sample_size)
...
print("size: " + str(x_training_data_0.shape[0]))

procedure: MLDGProcedure = MLDGProcedure(Procedure.compile_model(model), training_data_dict, validation_data_dict, validation_data_dict, 1000, 512, "adam", 10000, alpha=0.0001, beta=0.0001, gamma=.0001)
procedure.train()