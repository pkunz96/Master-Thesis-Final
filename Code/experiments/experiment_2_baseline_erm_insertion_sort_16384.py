                    ...
                    for learning_rate in [0.01, 0.001, 0.0001]:
                        for beta in [1]:
                            for gamma in [1]:
                                ...
                                search_space.append((Configuration(neuron_count_arr, activation_func_list,loss_func_arr, forwarding_arr, binary_arr), Hyperparameters(learning_rate, beta, gamma, 1000, 64, "adam", 50, sample_size=16384, iterations=5)))
