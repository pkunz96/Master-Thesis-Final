...
class BaselineERMInsertionSortSearch(HyperoptBayesianSearch):
    ...
    base_dir = "./baseline_erm_insertion_sort_65536"
                    ...
                    for learning_rate in [0.1, 0.01, 0.001, 0.0001]:
                        for beta in [0.1, 0.01, 0.001, 0.0001]:
                            for gamma in [0.1, 0.01, 0.001, 0.0001]:
                                ...
                                search_space.append((Configuration(neuron_count_arr, activation_func_list,loss_func_arr, forwarding_arr, binary_arr), Hyperparameters(learning_rate, beta, gamma, 1000, 64, "adam", 300, sample_size=65536, iterations=5)))
