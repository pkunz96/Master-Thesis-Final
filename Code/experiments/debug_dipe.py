...
extractor: List[Layer] = [
    ...
    Layer(name="extractor_out", input_dim=2048, output_dim=3, forward=True, loss_function=None, loss_weight=1.0,activation_function_name="sigmoid")
]

predictor: List[Layer] = [
    Layer(name="predictor_in", input_dim=3, output_dim=2048, forward=True, loss_function=binary_representation_loss, loss_weight=1.0, activation_function_name="sigmoid"),
