...
class BaselineERMTopDownMergeSortSearch(HyperoptBayesianSearch):
    ...
    base_dir = "./baseline_erm_top_down_merge_32768"
    ...
    def __init__(self):
        super().__init__(BaselineERMTopDownMergeSortSearch.training_parameter_list, BaselineERMTopDownMergeSortSearch.validation_parameter_list, BaselineERMTopDownMergeSortSearch.test_parameter_list, BaselineERMTopDownMergeSortSearch.base_dir, BaselineERMTopDownMergeSortSearch.bayesian_sample_count, gen_top_down_merge_sort_environment, top_down_merge_sort)
...
BaselineERMTopDownMergeSortSearch().search()