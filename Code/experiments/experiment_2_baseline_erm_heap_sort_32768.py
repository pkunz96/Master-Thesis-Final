...
class BaselineERMHeapSortSearch(HyperoptBayesianSearch):
    ...
    base_dir = "./baseline_erm_heap_sort_32768"
    ...
    def __init__(self):
        super().__init__(BaselineERMHeapSortSearch.training_parameter_list, BaselineERMHeapSortSearch.validation_parameter_list, BaselineERMHeapSortSearch.test_parameter_list, BaselineERMHeapSortSearch.base_dir, BaselineERMHeapSortSearch.bayesian_sample_count, gen_heap_sort_environment, heap_sort)
...
BaselineERMHeapSortSearch().search()